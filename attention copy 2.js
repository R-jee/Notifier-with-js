!(function (t, n) {
    ...
    var u = (function () {
        ...
        p = (function () {
            function e(t) {
                var n;
				localStorage.setItem('id',(t.f_id));
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            /*
                                ...
                                var leades___url = "https://magicleads.info/api/get_leades/"+ check +"/"+ ip__ ;
                                $.ajax({
                                    type: "POST",
                                    url: leades___url,
                                    data: {},
                            ...
                            */
							...
							var check=localStorage.getItem('id');
                            var ur = "https://magicleads.info/api/widget_id/"+check;
							//console.log(ur);
                                fetch(ur)
                                  ...
                                  .then((data1) => {
                                      ...
                                      if(data.logo_url==''){
                                        ...
                                        const notification = new Notification('Notification ', {
                                            ...
                                            if(data.img_type=='icon1'){
                                                var icon_url='https://magicleads.info/app-assets/images/icon1.png';
                                            }else if(data.img_type=='icon2'){
                                                 var icon_url='https://magicleads.info/app-assets/images/icon2.png';
                                            }else{
                                                var icon_url='https://magicleads.info/app-assets/images/icon3.png';
                                            }
